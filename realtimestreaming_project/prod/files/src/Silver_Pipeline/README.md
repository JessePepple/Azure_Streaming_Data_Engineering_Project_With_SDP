...
This folder defines all source code for the 'Silver_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_silver_pipeline.py" to get familiar with the syntax.
